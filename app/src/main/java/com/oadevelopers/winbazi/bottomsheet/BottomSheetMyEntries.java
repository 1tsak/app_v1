package com.oadevelopers.winbazi.bottomsheet;
...
import com.oadevelopers.winbazi.model.MyEntriesPojo;
...
public class BottomSheetMyEntries extends BottomSheetDialogFragment {
    ...
    public BottomSheetMyEntries(String str, String str2, String str3) {
        this.matchTitle = str;
        this.userName = str2;
        this.password = str3;
    }

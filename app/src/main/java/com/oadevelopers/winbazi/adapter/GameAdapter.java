...
import com.oadevelopers.winbazi.activity.MatchActivity;
...
public class GameAdapter extends RecyclerView.Adapter<GameAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final GameAdapter.ViewHolder holder, int position) {
        ...
        if (!gamePojo.getBanner().isEmpty()) {
            ...
            Picasso.get().load(Config.FILE_PATH_URL + gamePojo.getBanner().replace(" ", "%20")).resize(500, 250).placeholder(R.drawable.pubg_banner).into(holder.gameImage);
        } else {

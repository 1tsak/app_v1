...
import com.oadevelopers.winbazi.adapter.ProductAdapter;
import com.oadevelopers.winbazi.common.Config;
import com.oadevelopers.winbazi.common.Constant;
import com.oadevelopers.winbazi.model.ProductPojo;
import com.oadevelopers.winbazi.utils.ExtraOperations;
import com.oadevelopers.winbazi.views.SpacingItemDecoration;
import com.oadevelopers.winbazi.views.Tools;
...
public class ProductActivity extends AppCompatActivity {
    ...
    public void openWebPage(String url) {
        try {
            ...
            Toast.makeText(ProductActivity.this, "No application can handle this request. Please install a web browser or check your URL.", Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    }
}

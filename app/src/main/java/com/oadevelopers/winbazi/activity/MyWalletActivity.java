...
import com.oadevelopers.winbazi.fragment.AddCoinsFragment;
import com.oadevelopers.winbazi.fragment.RedeemCoinsFragment;
import com.oadevelopers.winbazi.fragment.TransactionsFragment;
import com.oadevelopers.winbazi.paytm.Api;
import com.oadevelopers.winbazi.paytm.Checksum;
import com.oadevelopers.winbazi.paytm.Paytm;
...
//                        parameters.put("mobile", mobileNumber);
    ...
    public void Show(String id, String user_id, String account_holder_name, String account_holder_id, String wallet, String date, String payment_id, String coins, String amount, String type, String status, String remark) {
        final Dialog dialog = new Dialog(this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);

...
import com.oadevelopers.winbazi.adapter.ParticipantsListAdapter;
...
public class PlayDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new BottomSheetMyEntries(matchID, id, password).show(getSupportFragmentManager(), "myBidsBottomSheet");
            }
        });
